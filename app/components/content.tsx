...
const ContentBlock = () => {
  ...
  return (
    ...
    >
      <div className="h-screen flex pt-24 w-full bg-[#151515] justify-center overflow-y-auto min-w-[250px]">
        {formData && mode && (
        ...
        {formData && !mode && algorithmData === "DES" && (
          <div className="w-full h-full flex flex-col">
            ...
            <div className="w-full sm:px-8 px-4 flex flex-col space-y-8 items-center">
              <h2 className="text-lg font-medium mt-4">Final Result</h2>
              <p className="text-sm font-mono">{formData && formData.result}</p>
            </div>
          </div>
        )}
        {formData &&
